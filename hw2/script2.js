// Alternate way of creating the bars. Where the bars are never exited and removed,
// but simply adjusted to new data
...
function setup(selectedDimension) {
    ...
    var newColorScale = colorScale(max);
